...
- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions
{
    ...
    [[BITHockeyManager sharedHockeyManager] configureWithIdentifier:@"05ac8bd875d7488b82b7ee849b725586"];
...
- (NSPersistentStoreCoordinator *)persistentStoreCoordinator
{
    ...
    NSURL *storeURL = [[self applicationDocumentsDirectory] URLByAppendingPathComponent:@"ManusSyncTable.sqlite"];
